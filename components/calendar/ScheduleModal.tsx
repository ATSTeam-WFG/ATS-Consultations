...
export function ScheduleModal({ date, agents, onClose, onScheduled }: ScheduleModalProps) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const res = await fetch('/api/sessions/schedule', {
      ...
      body: JSON.stringify({ agent_id: agentId, session_date: date, notes, session_type: sessionType }),
    })
    ...
    <div style={{
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1.25rem' }}>
          <div>
            <div style={{ fontWeight: 700, fontSize: '1rem' }}>Schedule Meeting</div>
