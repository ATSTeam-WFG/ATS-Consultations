...
drop policy if exists "Team can manage all agents" on agents;
create policy "Team can manage all agents" on agents
...
drop policy if exists "Team can manage all sessions" on sessions;
create policy "Team can manage all sessions" on sessions
  for all using (auth.role() = 'authenticated')
  with check (auth.role() = 'authenticated');
...
drop policy if exists "Team can view all session analysis" on session_analysis;
create policy "Team can view all session analysis" on session_analysis
  for all using (auth.role() = 'authenticated')
  with check (auth.role() = 'authenticated');
...
drop policy if exists "Team can view all problems" on problems;
create policy "Team can view all problems" on problems
  for all using (auth.role() = 'authenticated')
  with check (auth.role() = 'authenticated');
...
drop policy if exists "Team can manage all tools" on tool_recommendations;
create policy "Team can manage all tools" on tool_recommendations
  for all using (auth.role() = 'authenticated')
  with check (auth.role() = 'authenticated');
...
drop policy if exists "Team can view all agent tool recommendations" on agent_tools_recommended;
create policy "Team can view all agent tool recommendations" on agent_tools_recommended
  for all using (auth.role() = 'authenticated')
  with check (auth.role() = 'authenticated');
...
drop policy if exists "Team can manage all trends" on trends;
create policy "Team can manage all trends" on trends
  for all using (auth.role() = 'authenticated')
  with check (auth.role() = 'authenticated');
...
drop policy if exists "Team can manage all playbooks" on playbooks;
create policy "Team can manage all playbooks" on playbooks
  for all using (auth.role() = 'authenticated')
  with check (auth.role() = 'authenticated');
...
drop policy if exists "Team can view all playbook sessions" on playbook_sessions;
create policy "Team can view all playbook sessions" on playbook_sessions
  for all using (auth.role() = 'authenticated')
  with check (auth.role() = 'authenticated');
